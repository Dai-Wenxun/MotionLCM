...
def parse_args():
    ...
    parser.add_argument("--persistent_data", action="store_true", help="retain Cycles data between video frames (uses more memory)")
...
def render_cli() -> None:
    ...
    for path in paths:
        ...
        render(
            ...
            device=cfg.device,
            fps=cfg.fps,
            persistent_data=cfg.persistent_data)
