...
from mld.transforms.joints2rots.customloss import camera_fitting_loss_3d, body_fitting_loss_3d
from mld.transforms.joints2rots.prior import MaxMixturePrior
...
class SMPLify3D():
    ...
    def __call__(self, init_pose, init_betas, init_cam_t, j3d, conf_3d=1.0, seq_ind=0):
        ...
        with torch.no_grad():
            ...
            final_loss = body_fitting_loss_3d(body_pose, preserve_pose, betas, model_joints[:, self.smpl_index],
                                              camera_translation,
                                              j3d[:, self.corr_index], self.pose_prior,
                                              joints3d_conf=conf_3d,
                                              joint_loss_weight=600.0,
                                              use_collision=self.use_collision, model_vertices=model_vertices,
